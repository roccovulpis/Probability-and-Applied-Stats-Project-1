...
public class PokemonMonteCarloSimulation extends MonteCarloSimulationInit{
	...
	public void drawMultipleHands(int numberOfRuns) {
		...
		for (int i = 0; i < deckSize; i++) {
			initilizeDeck(numberOfPokemonCards, numberOfEnergyCards);
			int goodHandCount = 0;
	...
	public void writeToFile() {
		...
		try {
			...
			BufferedWriter writer = new BufferedWriter(new FileWriter("pokemon_probabilties.csv"));
			writer.write(header);
